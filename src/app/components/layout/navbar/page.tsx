export default function Sidebar() {
  return (
    <aside
      ...
      className="fixed top-0 left-0 z-40 w-64 max-w-xs h-full pt-20 transition-transform -translate-x-full bg-white border-r border-blue-200 sm:translate-x-0 dark:bg-blue-800 dark:border-blue-700"
      aria-label="Sidebar"
    >
      <div className="mt-10 px-3 pb-4 overflow-y-auto bg-white dark:bg-blue-800">
        <ul className="space-y-1 font-medium">
          <li>
            <a
              href="#"
              className="flex items-center p-2 text-blue-900 rounded-lg dark:text-white hover:bg-blue-100 dark:hover:bg-blue-700"
            >
              <svg
                aria-hidden="true"
                className="w-6 h-6 text-blue-500 transition duration-75 dark:text-blue-400 group-hover:text-blue-900 dark:group-hover:text-white"
                fill="currentColor"
                viewBox="0 0 20 20"
          ...
          <li>
            ...
            >
              <svg
                aria-hidden="true"
                className="flex-shrink-0 w-6 h-6 text-blue-500 transition duration-75 dark:text-blue-400 group-hover:text-blue-900 dark:group-hover:text-white"
                fill="currentColor"
                viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg"
              >
